...
export default function Toolss() {
  return (
    <div>
      ...
      <div className="flex justify-center m-2 sm:m-10 gap-6">
        {Tools.map((tool) => (
          <div
            className="flex items-center gap-3 p-2 w-full md:w-1/4 border border-zinc-700 rounded-md hover:bg-zinc-700"
            key={tool.id}
            data-aos="fade-up"
          >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-6 m-2 sm:m-10">
